                    ...
                    <div class="card-body">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button v-if="!edit_todo_id" type="button" class="btn btn-info text-white" @click="saveTodo()">Adicionar</button>
                                <button v-else type="button" class="btn btn-info text-white" @click="updateTodo()">Atualizar</button>
                            </div>
                        </div>

                        <button type="button" class="btn btn-sm text-danger float-right" @click="resetTodo()">Resetar</button>
                        ...
                        <table class="table table-bordered mt-4">
                            ...
                            <tbody>
                                <tr v-for="(todo,index) in todos" :key="index">
                                    ...
                                    <td>{{ todo.name }}</td>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-danger" @click="deleteTodo(--index)">Deletar</button>
                                        <button type="button" class="btn btn-sm btn-info" @click="editTodo(--index)">Editar</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
